...
rock_btn=Button(frame,text="rock",font=("Calbiri",18,"bold"),background="#274853",fg="white",width=12,pady=5,command=lambda: player_choice(choices[0]))
rock_btn.grid(row=1,column=1,padx=8,pady=5)
paper_btn=Button(frame,text="paper",font=("Calbiri",18,"bold"),background="#15357A",fg="white",width=12,pady=5,command=lambda: player_choice(choices[1]))
paper_btn.grid(row=1,column=2,padx=8,pady=5)
scissors_btn=Button(frame,text="scissors",font=("Calbiri",18,"bold"),background="#520000",fg="white",width=12,pady=5,command=lambda: player_choice(choices[2]))
